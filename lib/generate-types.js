...
const SCALAR_MAP = {
  ...
  BCTextBehaviourType: 'TextBehaviourType',
  MSExportLayerOptions: 'ExportLayerOptions',
  MSStyleBlurType: 'StyleBlurType',
  MSBooleanOperation: 'BooleanOperation',
  MSTextStyleVerticalAlignment: 'TextStyleVerticalAlignment',
  MSCurveMode: 'CurveMode',
  MSUserVisibleScaleType: 'UserVisibleScaleType',
  BCTextLineSpacingBehaviourType: 'TextLineSpacingBehaviourType',
  MSBorderPositionType: 'BorderPositionType',
  MSPatternFillType: 'PatternFillType',
  MSPointRadiusBehaviour: 'PointRadiusBehaviour',
  MSBlendMode: 'BlendMode',
  BCFillType: 'FillType',
  MSExportFormatNamingScheme: 'ExportFormatNamingScheme',
  MSGradientType: 'GradientType',
  MSDecorationType: 'DecorationType',
  NSWindingRule: 'WindingRule',
  MSLayerResizingType: 'LayerResizingType',
  BCConstraint: 'Constraint',
}
